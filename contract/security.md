...
Contract directory entries are byte-read and must equal the exact closed layout.
Canonical text must be well-formed UTF-8; decoding never substitutes invalid
bytes. Offline Origin validation requires the input to equal its canonical URL
