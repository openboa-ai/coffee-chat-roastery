...
import { contractBundlePaths, loadContractManifest } from "./manifest.js";
...
export async function digestContractBundle(repositoryRoot) {
    ...
    for (const path of paths) {
        try {
            ...
            throw new Error(`contract bundle contains a symbolic link or non-regular file: ${path}`);
        }
