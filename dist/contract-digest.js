...
import { captureDirectory, readVerifiedFile, verifyDirectories, } from "./verified-read.js";
function contractFiles(root, current, ancestors) {
    try {
        ...
        const files = readdirSync(current, { withFileTypes: true }).flatMap((entry) => {
            ...
            return [
                {
                    content: readVerifiedFile(absolute, directories, "unsafe_contract_entry"),
